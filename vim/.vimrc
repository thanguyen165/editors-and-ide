...
" Example colors for YCM suggestions
hi Pmenu ctermfg=black ctermbg=lightgrey guifg=black guibg=lightgrey
hi PmenuSel ctermfg=black ctermbg=LightGreen guifg=black guibg=LightGreen
...
set statusline+=\ ascii:\ (%b,\ 0x%B\)\ row:\ %l\ col:\ %c\ percent:\ %p%%
...
function! Mode()
    ...
    elseif mode == "\<C-V>"
        ...
        return mode . ' '  " fallback highlight for unknown mode
    endif
endfunction
...
augroup cursor_off
    ...
    autocmd WinEnter * set nocursorcolumn
augroup END
